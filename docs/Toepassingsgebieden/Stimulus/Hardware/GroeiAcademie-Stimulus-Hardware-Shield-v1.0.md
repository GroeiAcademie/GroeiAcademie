...
H5 is de centrale 10-polige Dupont-connector voor het ADS1115-pad en de vier analoge sensorlijnen. H6 is een afzonderlijk 4x2-jumperveld. Met vier geplaatste jumpers verbindt H6 H5 pin 7 tot en met pin 10 met Arduino A0 tot en met A3. H7, de 3-pin jumper 5V/3V3, is in v0.10.1 uitsluitend de voedingskeuze voor het FSR/ADS1115-pad. SW1 is uitsluitend de ADDR-keuze voor de ADS1115-adreskeuze. H8 is de TFTSPI-displayconnector.
...
|---|---|---|
| `examples/Stimulus/ADC_Validatie_Native/ADC_Validatie_Native.ino` | `ADC_BACKEND_NATIVE` | Geen ADS1115-module op H5. Vier jumpers op jumperveld H6. H6 verbindt H5 pin 7-10 met Arduino A0-A3. |

...
Tijdens versie v1.1.1 worden volgende Arduino Uno R3-vormfactorborden ondersteund:
...
Daarnaast zijn vanaf v1.1.0 volgende drie boards **experimenteel** toegevoegd, nog niet fysiek hardwarematig gevalideerd:
...
• HX1838 IR Receiver als extra Input-route, DATA verbonden met Arduino D12;
...
Het GroeiAcademie Stimulus Hardware Shield v1.1.1 werd bewust modulair ontworpen. Niet iedere
...
Experimenteel (nog niet hardwarematig gevalideerd) vanaf v1.1.0:
...
==============================================================================
3.2) Inventariseren van het GroeiAcademie Stimulus Hardware Shield v1.1.1
==============================================================================
...
Input-routes in v1.1.1

Naast de rechtstreekse keymatrix op H1 behoudt het v1.1.1-schema de optionele PCF8574-uitbreiding uit v1.1.0 en voegt het een HX1838 IR Receiver toe.
...
• DATA is verbonden met Arduino D12;
...
• de DATA-lijn verbonden is met Arduino D12.
...
Wanneer geen geldige toetsaanslag ontvangen wordt, controleer eerst de aansluiting van GND, VCC en DATA, de verbinding met D12 en de gebruikte afstandsbediening.

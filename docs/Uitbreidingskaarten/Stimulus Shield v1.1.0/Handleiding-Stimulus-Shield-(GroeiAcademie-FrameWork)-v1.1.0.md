...
Tijdens versie v1.1.0 worden volgende Arduino Uno R3-vormfactorborden ondersteund:
...
Het GroeiAcademie Stimulus Hardware Shield v1.1.0 werd bewust modulair ontworpen. Niet iedere
...
==============================================================================
3.2) Inventariseren van het GroeiAcademie Stimulus Hardware Shield v1.1.0
==============================================================================
...
De inventarisatie moet vastleggen of het gebruikte keypad rechtstreeks digitaal of via PCF8574 wordt uitgelezen. Wanneer PCF8574 gebruikt wordt, moet het ingestelde I2C-adres uniek zijn op de bus.

...
Voor wie gewoon een bedrag wil geven, ongeacht de hoogte, zonder overleg of proces: [https://shop.groeiacademie.be/product-categorie/donaties/](https://shop.groeiacademie.be/product-categorie/donaties/)
...
Wil je weten waar je bijdrage naartoe gaat, iets specifieks steunen, of iets anders dan geld aanbieden? Dat noemen we sponsoring. Neem contact op via:

- e-mail: `support@groeiacademie.be`;
- contactformulier: `https://groeiacademie.be/contactformulier/`.

Vermeld bij voorkeur welke vorm van steun je aanbiedt, of het eenmalig of terugkerend is, eventuele voorwaarden, en of je publiek vermeld wilt worden.
...
### Onafhankelijkheid van het project

Sponsoring geeft geen beslissingsrecht over de roadmap, architectuur, technische keuzes, licentie of governance van het project.

Een sponsor kan, net zoals iedere andere betrokkene, ideeën of voorstellen indienen. Sponsoring garandeert geen opname, voorrang, feature of versnelde bugfix. De maintainers blijven verantwoordelijk voor alle projectbeslissingen.

Gebruik van de naam en het merk GroeiAcademie door een sponsor blijft onderworpen aan het geldende merkenbeleid. Zie `TRADEMARKS.md`.
...
Een sponsor kan ook vragen anoniem te blijven.

...
// INPUT TESTEN:
// Dit voorbeeld test uitsluitend INPUT_TYPE_HX1838. Zet in UserConfig.h:
...
//
// mappingTestMenu[] hieronder bevat, per HX1838_TOETSENINDELING, de volledige set opschriften die
// die indeling kan opleveren, elk gekoppeld aan zijn eigen, herkenbare functie. Zo toont het

...
// ============================================================================
#define HX1838_TOETSENINDELING_3x4                    1   // remote met 17 toetsen: enkel de 12 toetsen van de 3x4-matrix (1-9, *, 0, #)
#define HX1838_TOETSENINDELING_REMOTE_17_TOETSEN      2   // remote met 17 toetsen: 3x4-matrix + navigatie (UP, DOWN, OK, LEFT, RIGHT)
#define HX1838_TOETSENINDELING_REMOTE_21_TOETSEN_MP3  3   // remote met 21 toetsen: 0-9 + MP3-toetsen
